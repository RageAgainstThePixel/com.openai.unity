    ...
    internal class RealtimeServerEventConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            return type switch
            {
                ...
                "conversation.item.added" => jObject.ToObject<ConversationItemAddedResponse>(serializer),
                "conversation.item.done" => jObject.ToObject<ConversationItemAddedResponse>(serializer),
                ...
                _ when type.StartsWith("response.output_text") => jObject.ToObject<ResponseTextResponse>(serializer),
