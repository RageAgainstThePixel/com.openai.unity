...
{
    internal class CompletionsTestFixture
    {
        ...
        public IEnumerator Test_1_GetBasicCompletion()
        {
            yield return AwaitTestUtilities.Await(async () =>
            {
                ...
                var result = await api.CompletionEndpoint.CreateCompletionAsync(completionPrompts,
                    temperature: 0.1, max_tokens: 5,
                    numOutputs: 5, engine: Engine.Davinci);
        ...
        public IEnumerator Test_2_GetStreamingCompletion()
        {
            yield return AwaitTestUtilities.Await(async () =>
            {
                ...
                }, completionPrompts, temperature: 0.1, max_tokens: 5, numOutputs: 5, engine: Engine.Davinci);
